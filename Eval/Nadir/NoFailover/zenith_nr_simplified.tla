...
\* BEGIN TRANSLATION (chksum(pcal) = "7c28162a" /\ chksum(tla) = "388780ee")
VARIABLES swSeqChangedStatus, controller2Switch, switch2Controller, 
          ...
          SetScheduledIRs, ir2sw, seqWorkerIsBusy, idThreadWorkingOnIR, pc
...
vars == << swSeqChangedStatus, controller2Switch, switch2Controller, 
           ...
           nextIRIDToSend, index, monitoringEvent, setIRsToReset, resetIR, 
           msg, irID, removedIR >>
