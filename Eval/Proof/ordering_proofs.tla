...
LEMMA IRQ_ordering_transit == (IRQ_ordering /\ Next /\ AUX_TypeOK) => IRQ_ordering'
PROOF OMITTED 
LEMMA C2S_ordering_transit == (C2S_ordering /\ Next /\ AUX_TypeOK) => C2S_ordering'
PROOF OMITTED 
...
LEMMA continuity_IRQ_to_C2S_transit == (continuity_IRQ_to_C2S /\ Next /\ AUX_TypeOK) => continuity_IRQ_to_C2S'
PROOF OMITTED 
LEMMA continuity_SEQ_to_IRQ_transit == (continuity_SEQ_to_IRQ /\ Next /\ AUX_TypeOK) => continuity_SEQ_to_IRQ'
PROOF OMITTED 
...
<1> QED BY PTL, <1>1, <1>2, continuity_C2S_to_switch_transit, AUX_TypeOK_is_inv DEF Spec
...
LEMMA StitchingLemma1 == 
    (continuity_C2S_to_switch /\ C2S_ordering /\ AUX_TypeOK) =>
        \A sw \in SW:
...
LEMMA StitchingLemma2 == 
    (continuity_C2S_to_switch /\ C2S_ordering /\ continuity_IRQ_to_C2S /\ AUX_TypeOK) =>
        \A sw \in SW:
...
LEMMA StitchingLemma3 == 
    (continuity_C2S_to_switch /\ C2S_ordering /\ continuity_IRQ_to_C2S /\ IRQ_ordering /\ AUX_TypeOK) =>
        \A sw \in SW:
...
LEMMA continuity_implies_ordering == 
    (Continuity /\ AUX_TypeOK) => AUX_SeqOrderPreserved
<1> SUFFICES ASSUME 
        Continuity, AUX_TypeOK
    PROVE 
...
BY PTL, Continuity_is_inv, continuity_implies_ordering, AUX_TypeOK_is_inv
====