...
\* Process variable rowRemove of process NIBRCEventHandler at line 1366 col 52 changed to rowRemove_
\* Process variable stepOfFailure of process NIBRCEventHandler at line 1367 col 50 changed to stepOfFailure_
\* Process variable NIBMsg of process RCNIBEventHandler at line 1463 col 15 changed to NIBMsg_
\* Process variable isBootStrap of process RCNIBEventHandler at line 1463 col 50 changed to isBootStrap_
\* Process variable op1 of process controllerSequencer at line 1510 col 48 changed to op1_
\* Process variable transaction of process controllerSequencer at line 1512 col 17 changed to transaction_
\* Process variable stepOfFailure of process controllerSequencer at line 1513 col 29 changed to stepOfFailure_c
\* Process variable NIBMsg of process OFCNIBEventHandler at line 1617 col 15 changed to NIBMsg_O
\* Process variable stepOfFailure of process controllerWorkerThreads at line 1642 col 64 changed to stepOfFailure_co
\* Process variable transaction of process controllerWorkerThreads at line 1643 col 15 changed to transaction_c
\* Process variable op_ir_status_change of process controllerWorkerThreads at line 1644 col 53 changed to op_ir_status_change_
...
Init == (* Global variables *)
        ...
        /\ pc = [self \in ProcSet |-> CASE self \in ({SW_SIMPLE_ID} \X SW) -> "SwitchSimpleProcess"
                                        ...
                                        [] self \in ( {"proc"} \X {RC_FAILOVER}) -> "RCFailoverReadFromNIB"
...
SwitchSimpleProcess(self) == /\ pc[self] = "SwitchSimpleProcess"
                             ...
                             /\ Assert(ingressPkt'[self].type = INSTALL_FLOW, 
                                       "Failure of assertion at line 1057, column 9.")
                             ...
                             /\ Assert(\/ switchLock[2] = self[2]
                                       \/ switchLock[2] = NO_LOCK, 
                                       "Failure of assertion at line 789, column 9 of macro called at line 1064, column 9.")
                             /\ switchLock' = <<NO_LOCK, NO_LOCK>>
...
SwitchRcvPacket(self) == /\ pc[self] = "SwitchRcvPacket"
                         ...
                         /\ Assert(\/ ingressIR'[self].type = RECONCILIATION_REQUEST
                                   ...
                                   "Failure of assertion at line 1089, column 9.")
                         /\ controllerLock = <<NO_LOCK, NO_LOCK>>
                         /\ switchLock \in {<<NO_LOCK, NO_LOCK>>, self}
                         /\ switchLock' = self
                         /\ controller2Switch' = [controller2Switch EXCEPT ![self[2]] = Tail(controller2Switch[self[2]])]
...
SwitchFromOFAPacket(self) == /\ pc[self] = "SwitchFromOFAPacket"
                             ...
                             /\ Assert(\/ egressMsg'[self].type = INSTALLED_SUCCESSFULLY
                                       ...
                                       "Failure of assertion at line 1117, column 9.")
...
SwitchNicAsicSendOutMsg(self) == /\ pc[self] = "SwitchNicAsicSendOutMsg"
                                 /\ IF swCanReceivePackets(self[2])
                                       THEN /\ controllerLock = <<NO_LOCK, NO_LOCK>>
                                            ...
                                            /\ Assert(\/ switchLock[2] = self[2]
                                                      \/ switchLock[2] = NO_LOCK, 
                                                      "Failure of assertion at line 789, column 9 of macro called at line 1126, column 17.")
                                            /\ switchLock' = <<NO_LOCK, NO_LOCK>>
...
SwitchOfaProcIn(self) == /\ pc[self] = "SwitchOfaProcIn"
                         ...
                         /\ Assert(ofaInMsg'[self].to = self[2], 
                                   "Failure of assertion at line 1154, column 9.")
                         /\ Assert(ofaInMsg'[self].IR  \in 1..MaxNumIRs, 
                                   "Failure of assertion at line 1155, column 9.")
                                ...
                                /\ IF swOFACanProcessIRs(self[2])
                                      THEN /\ controllerLock = <<NO_LOCK, NO_LOCK>>
                                           ...
                                           /\ IF ofaInMsg[self].type = INSTALL_FLOW
                                                 ...
                                                 ELSE /\ Assert(FALSE, 
                                                                "Failure of assertion at line 1168, column 21.")
...
SwitchOfaProcOut(self) == /\ pc[self] = "SwitchOfaProcOut"
                          ...
                          /\ Assert(ofaOutConfirmation'[self] \in 1..MaxNumIRs, 
                                    "Failure of assertion at line 1189, column 9.")
...
SwitchInstallerProc(self) == /\ pc[self] = "SwitchInstallerProc"
                             ...
                             /\ Assert(installerInIR'[self] \in 1..MaxNumIRs, 
                                       "Failure of assertion at line 1221, column 8.")
...
SwitchFailure(self) == /\ pc[self] = "SwitchFailure"
                       ...
                       /\ Assert((self[2]) \in Head(sw_fail_ordering_var), 
                                 "Failure of assertion at line 543, column 9 of macro called at line 1273, column 9.")
                       ...
                       /\ IF failedElem'[self] = "cpu"
                             THEN /\ pc[<<SW_RESOLVE_PROC, self[2]>>] = "SwitchResolveFailure"
                                  /\ Assert(switchStatus[self[2]].cpu = NotFailed, 
                                            "Failure of assertion at line 616, column 9 of macro called at line 1282, column 17.")
                             ...
                             ELSE /\ IF failedElem'[self] = "ofa"
                                        THEN /\ pc[<<SW_RESOLVE_PROC, self[2]>>] = "SwitchResolveFailure"
                                             /\ Assert(switchStatus[self[2]].cpu = NotFailed /\ switchStatus[self[2]].ofa = NotFailed, 
                                                       "Failure of assertion at line 668, column 9 of macro called at line 1285, column 17.")
                                        ...
                                        ELSE /\ IF failedElem'[self] = "installer"
                                                   THEN /\ pc[<<SW_RESOLVE_PROC, self[2]>>] = "SwitchResolveFailure"
                                                        /\ Assert(switchStatus[self[2]].cpu = NotFailed /\ switchStatus[self[2]].installer = NotFailed, 
                                                                  "Failure of assertion at line 712, column 9 of macro called at line 1288, column 17.")
                                                        ...
                                                        /\ IF switchStatus'[self[2]].nicAsic = NotFailed /\ switchStatus'[self[2]].ofa = NotFailed
                                                              THEN /\ Assert(switchStatus'[self[2]].installer = Failed, 
                                                                             "Failure of assertion at line 715, column 13 of macro called at line 1288, column 17.")
                                                   ...
                                                   ELSE /\ IF failedElem'[self] = "nicAsic"
                                                              THEN /\ pc[<<SW_RESOLVE_PROC, self[2]>>] = "SwitchResolveFailure"
                                                                   /\ Assert(switchStatus[self[2]].nicAsic = NotFailed, 
                                                                             "Failure of assertion at line 562, column 9 of macro called at line 1291, column 17.")
                                                                   ...
                                                                   /\ swSeqChangedStatus' = Append(swSeqChangedStatus, statusMsg'[self])
                                                              ELSE /\ Assert(FALSE, 
                                                                             "Failure of assertion at line 1292, column 14.")
                                                                   /\ UNCHANGED << swSeqChangedStatus, 
                                                                                   controller2Switch, 
                                                                                   switchStatus, 
                                                                                   controlMsgCounter, 
...
SwitchResolveFailure(self) == /\ pc[self] = "SwitchResolveFailure"
                              ...
                              /\ IF recoveredElem'[self] = "cpu"
                                    THEN /\ ofaStartingMode(self[2]) /\ installerInStartingMode(self[2])
                                         /\ Assert(switchStatus[self[2]].cpu = Failed, 
                                                   "Failure of assertion at line 643, column 9 of macro called at line 1317, column 39.")
                                    ...
                                    ELSE /\ IF recoveredElem'[self] = "nicAsic"
                                               THEN /\ nicAsicStartingMode(self[2])
                                                    /\ Assert(switchStatus[self[2]].nicAsic = Failed, 
                                                              "Failure of assertion at line 588, column 9 of macro called at line 1318, column 46.")
                                               ...
                                               ELSE /\ IF recoveredElem'[self] = "ofa"
                                                          THEN /\ ofaStartingMode(self[2])
                                                               /\ Assert(switchStatus[self[2]].cpu = NotFailed /\ switchStatus[self[2]].ofa = Failed, 
                                                                         "Failure of assertion at line 690, column 9 of macro called at line 1319, column 42.")
                                                          ...
                                                          ELSE /\ IF recoveredElem'[self] = "installer"
                                                                     THEN /\ installerInStartingMode(self[2])
                                                                          /\ Assert(switchStatus[self[2]].cpu = NotFailed /\ switchStatus[self[2]].installer = Failed, 
                                                                                    "Failure of assertion at line 734, column 9 of macro called at line 1320, column 48.")
                                                                          /\ switchStatus' = [switchStatus EXCEPT ![self[2]].installer = NotFailed]
                                                                          /\ IF switchStatus'[self[2]].nicAsic = NotFailed /\ switchStatus'[self[2]].ofa = NotFailed
                                                                                THEN /\ Assert(switchStatus'[self[2]].installer = NotFailed, 
                                                                                               "Failure of assertion at line 737, column 13 of macro called at line 1320, column 48.")
                                                                                     /\ controlMsgCounter' = [controlMsgCounter EXCEPT ![self[2]] = controlMsgCounter[self[2]] + 1]
                                                                                     /\ statusResolveMsg' = [statusResolveMsg EXCEPT ![self] = [type |-> KEEP_ALIVE,
                                                                                                                                                swID |-> self[2],
                                                                                                                                                num |-> controlMsgCounter'[self[2]],
                                                                                ...
                                                                                ELSE /\ TRUE
                                                                                     /\ UNCHANGED << swSeqChangedStatus, 
                                                                                                     ...
                                                                                                     statusResolveMsg >>
                                                                     ELSE /\ Assert(FALSE, 
                                                                                    "Failure of assertion at line 1321, column 14.")
                                                                          /\ UNCHANGED << swSeqChangedStatus, 
                                                                                          switchStatus, 
                                                                                          controlMsgCounter, 
                                                                                          statusResolveMsg >>
...
ghostProc(self) == /\ pc[self] = "ghostProc"
                   ...
                   /\ Assert(\/ switchLock[2] = switchLock[2]
                             \/ switchLock[2] = NO_LOCK, 
                             "Failure of assertion at line 789, column 9 of macro called at line 1355, column 9.")
                   /\ switchLock' = <<NO_LOCK, NO_LOCK>>
                                     ...
                                     /\ IF stepOfFailure_'[self] # 2
                                           THEN /\ IF (nextTrans'[self].name = "PrepareIR")
                                                      THEN /\ Assert(nextTrans'[self].ops[1].table = NIBT_CONTROLLER_STATE, 
                                                                     "Failure of assertion at line 945, column 9 of macro called at line 1380, column 17.")
                                                           /\ Assert(Len(nextTrans'[self].ops[1].key) = 2, 
                                                                     "Failure of assertion at line 946, column 9 of macro called at line 1380, column 17.")
                                                           ...
                                                           /\ Assert(nextTrans'[self].ops[2].table = NIBT_SET_SCHEDULED_IRS, 
                                                                     "Failure of assertion at line 948, column 9 of macro called at line 1380, column 17.")
                                                      ...
                                                      ELSE /\ IF (nextTrans'[self].name = "ScheduleIR")
                                                                 THEN /\ Assert(nextTrans'[self].ops[1].table = NIBT_IR_QUEUE, 
                                                                                "Failure of assertion at line 954, column 9 of macro called at line 1380, column 17.")
                                                                      /\ IRQueueNIB' = Append(IRQueueNIB, nextTrans'[self].ops[1].value)
                                                                      /\ Assert(nextTrans'[self].ops[2].table = NIBT_CONTROLLER_STATE, 
                                                                                "Failure of assertion at line 956, column 9 of macro called at line 1380, column 17.")
                                                                      /\ Assert(Len(nextTrans'[self].ops[2].key) = 2, 
                                                                                "Failure of assertion at line 957, column 9 of macro called at line 1380, column 17.")
                                                                 ...
                                                                 ELSE /\ IF (nextTrans'[self].name = "RCScheduleIRInOneStep")
                                                                            THEN /\ Assert(nextTrans'[self].ops[1].table = NIBT_IR_QUEUE, 
                                                                                           "Failure of assertion at line 963, column 9 of macro called at line 1380, column 17.")
                                                                                 /\ IRQueueNIB' = Append(IRQueueNIB, nextTrans'[self].ops[1].value)
                                                                                 /\ value' = [value EXCEPT ![self] = [IRStatusNIB |-> IRStatus,
                                                                                                                            IRQueueNIB |->IRQueueNIB',
                                                                                                                            SetScheduledIRsNIB |-> SetScheduledIRs,
                                                                            ...
                                                                            ELSE /\ IF (nextTrans'[self].name = "SeqReadNIBStates")
                                                                                       ...
                                                                                       ELSE /\ IF (nextTrans'[self].name = "OFCReadNIBStates")
                                                                                                  ...
                                                                                                  ELSE /\ IF (nextTrans'[self].name = "UpdateControllerState")
                                                                                                             THEN /\ Assert(nextTrans'[self].ops[1].table = NIBT_CONTROLLER_STATE, 
                                                                                                                            "Failure of assertion at line 992, column 17 of macro called at line 1380, column 17.")
                                                                                                                  /\ Assert(Len(nextTrans'[self].ops[1].key) = 2, 
                                                                                                                            "Failure of assertion at line 993, column 17 of macro called at line 1380, column 17.")
                                                                                                                  /\ controllerStateNIB' = [controllerStateNIB EXCEPT ![nextTrans'[self].ops[1].key] = nextTrans'[self].ops[1].value]
                                                                                                                  /\ UNCHANGED << FirstInstall, 
                                                                                                                                  IRStatus, 
                                                                                                                                  IRQueueNIB, 
                                                                                                             ...
                                                                                                             ELSE /\ IF (nextTrans'[self].name = "RemoveIR")
                                                                                                                        THEN /\ Assert(nextTrans'[self].ops[1].table = NIBT_IR_QUEUE, 
                                                                                                                                       "Failure of assertion at line 996, column 17 of macro called at line 1380, column 17.")
                                                                                                                        ...
                                                                                                                        ELSE /\ IF (nextTrans'[self].name = "OFCChangeIRStatus2Sent")
                                                                                                                                   THEN /\ Assert(nextTrans'[self].ops[1].table = NIBT_IR_STATUS, 
                                                                                                                                                  "Failure of assertion at line 1004, column 17 of macro called at line 1380, column 17.")
                                                                                                                                        /\ Assert(Len(nextTrans'[self].ops) = 1, 
                                                                                                                                                  "Failure of assertion at line 1005, column 17 of macro called at line 1380, column 17.")
                                                                                                                                   ...
                                                                                                                                   ELSE /\ IF (nextTrans'[self].name = "ChangeSetScheduledIRs")
                                                                                                                                              THEN /\ Assert(nextTrans'[self].ops[1].table = NIBT_SET_SCHEDULED_IRS, 
                                                                                                                                                             "Failure of assertion at line 1010, column 17 of macro called at line 1380, column 17.")
                                                                                                                                                   /\ Assert(Len(nextTrans'[self].ops) = 1, 
                                                                                                                                                             "Failure of assertion at line 1011, column 17 of macro called at line 1380, column 17.")
                                                                                                                                              ...
                                                                                                                                              ELSE /\ IF (nextTrans'[self].name = "UpdateIRTag")
                                                                                                                                                         THEN /\ Assert(nextTrans'[self].ops[1].table = NIBT_IR_QUEUE, 
                                                                                                                                                                        "Failure of assertion at line 1014, column 17 of macro called at line 1380, column 17.")
                                                                                                                                                              /\ Assert(Len(nextTrans'[self].ops) = 1, 
                                                                                                                                                                        "Failure of assertion at line 1015, column 17 of macro called at line 1380, column 17.")
                                                                                                                                                              /\ Assert(Len(IRQueueNIB) > 0, 
                                                                                                                                                                        "Failure of assertion at line 1016, column 17 of macro called at line 1380, column 17.")
                                                                                                                                                              /\ IRIndex' = [IRIndex EXCEPT ![self] = CHOOSE x \in DOMAIN IRQueueNIB: IRQueueNIB[x].IR = nextTrans'[self].ops[1].key]
                                                                                                                                                              /\ Assert(IRIndex'[self] # -1, 
                                                                                                                                                                        "Failure of assertion at line 1018, column 17 of macro called at line 1380, column 17.")
                                                                                                                                                         ...
                                                                                                                                                         ELSE /\ IF (nextTrans'[self].name = "FirstInstallIR")
                                                                                                                                                                    THEN /\ Assert(Len(nextTrans'[self].ops) = 2, 
                                                                                                                                                                                   "Failure of assertion at line 1021, column 17 of macro called at line 1380, column 17.")
                                                                                                                                                                         /\ Assert(nextTrans'[self].ops[1].table = NIBT_IR_STATUS, 
                                                                                                                                                                                   "Failure of assertion at line 1022, column 17 of macro called at line 1380, column 17.")
                                                                                                                                                                         /\ IRStatus' = [IRStatus EXCEPT ![nextTrans'[self].ops[1].key] = nextTrans'[self].ops[1].value]
                                                                                                                                                                         /\ Assert(nextTrans'[self].ops[2].table = NIBT_FIRST_INSTALL, 
                                                                                                                                                                                   "Failure of assertion at line 1024, column 17 of macro called at line 1380, column 17.")
...
RCFailoverReadFromNIB(self) == /\ pc[self] = "RCFailoverReadFromNIB"
                               /\ controllerLock = <<NO_LOCK, NO_LOCK>>
                               /\ switchLock = <<NO_LOCK, NO_LOCK>>
                               /\ controllerSubmoduleFailStat[<<rc0,CONT_SEQ>>] = Failed /\
                                    controllerSubmoduleFailStat[<<rc0,CONT_RC_NIB_EVENT>>] = Failed
...
RCFailoverProc(self) == RCFailoverReadFromNIB(self)
...
OFCNIBEventHanderProc(self) == /\ pc[self] = "OFCNIBEventHanderProc"
                               ...
                               /\ IF localIRSet'[self] # NIBIRSet'[self]
                                     THEN /\ IRQueueOFC' = SelectSeq(NIBMsg_O'[self].value.IRQueueNIB, LAMBDA i: IRStatusOFC[i.IR] = IR_NONE)
                                          /\ Assert(Len(IRQueueOFC') <= MaxNumIRs, 
                                                    "Failure of assertion at line 1631, column 17.")
                                     ELSE /\ TRUE
