...
VARIABLES dependencyGraph, IRStatus, FirstInstall, irCounter
...
internal_zenith_vars == <<
    ...
    stepOfFailure_, index, stepOfFailure_c, 
    monitoringEvent, setIRsToReset, resetIR, stepOfFailure, msg, 
    controllerFailedModules, irCounter
>>
...
IRCriticalSection == 
    LET 
        IRCriticalSet == {
            "ControllerThreadSendIR", "ControllerThreadForwardIR", "RemoveFromScheduledIRSet"
        }
    IN   
